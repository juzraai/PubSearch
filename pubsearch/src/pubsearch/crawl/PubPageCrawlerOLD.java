 ...
 * @author Zsolt
 */
public class PubPageCrawlerOLD extends ACrawler {
    ...
    public PubPageCrawlerOLD(PDatabase pdb, String url, int transLev) {
        this.pdb = pdb;
        this.url = url;
                ...
                if (null != authors && null != title) {
                    ...
                    if (transLev > 0 && !isInterrupted()) {
                        ...
                        if (null != refPubListURL && null == pdb.getRefPubListPattern()) {
                            ...
                            ResultListCrawlerOLD rlc = new ResultListCrawlerOLD(pdb, refPubListURL, qs, "GET", transLev - 1);
                            rlc.launch(false);
                            ...
                            if (null != refPubList) {
                                ...
                                if (refPubURLs.size() > 0) {
                                    for (String refPubURL : refPubURLs) {
                                        PubPageCrawlerOLD ppc = new PubPageCrawlerOLD(pdb, refPubURL, transLev - 1);
                                        ppc.launch(false);
